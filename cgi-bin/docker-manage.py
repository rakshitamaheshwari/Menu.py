...
for i in flist[1:]:
	...
	print("<td>")
	print("<a target='cframe' href='http://192.168.43.44:4200'>console</a>")
	print("</td>")
...
print("</table>")
print("""<input type='button' value='New Container' onclick="window.location.href='http://192.168.43.44/cgi-bin/docker-image-list.py'" />""")
